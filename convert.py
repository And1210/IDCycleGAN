...
def validate(configuration):
    ...
    for i, data in tqdm(enumerate(val_dataset)):
        ...
        for j in range(bs):
            ...
            # if (not os.path.exists(val_dataset.dataset.sim_img_paths[i*bs+j].replace('/val/', '/val_IDC6/'))):
            ...
            output.save(val_dataset.dataset.sim_img_paths[i*bs+j].replace('/train/', '/train_IDC6/'))
